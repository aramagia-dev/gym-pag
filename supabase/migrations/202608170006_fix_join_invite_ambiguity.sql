-- Fix the PL/pgSQL output-column ambiguity in invite-code joining.
...
begin
  ...
  if inserted_count = 1 then
    ...
    return query select invite_row.group_id, true;
  end if;

  return query select invite_row.group_id, false;
end;
$$;
