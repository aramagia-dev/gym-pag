-- Fix the PL/pgSQL output-column ambiguity in group creation.
drop function if exists public.create_group(text, text);

create function public.create_group(group_name text, group_description text)
